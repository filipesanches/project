...
const casesNotes = () => {
  ...
  const showPopup = (data) => {
    ...
    fetch(
      `https://filipesanches.github.io/project/assets/html/template_popup/${data}.html`,
    )
      .then((response) => {
  ...
  const handleEmailAutomateButtonClick = (e) => {
    ...
    const templateHTML = fetch(
      `https://filipesanches.github.io/project/assets/html/template_email/${dataEmail}.html`,
    ).then((e) => e.text());
  ...
  const dadosQa = fetch(
    'https://filipesanches.github.io/project/assets/js/dadosqa.json',
  ).then((e) => e.json());
  dadosQa
    .then((data) => {
  ...
  const alertsContent = fetch(
    'https://filipesanches.github.io/project/assets/html/template_alert_content/tmplate_alert.html',
  ).then((e) => e.text());
  alertsContent
    .then((data) => {
...
const structureHTML = fetch(
  'https://filipesanches.github.io/project/assets/html/estrutura.html',
).then((e) => e.text());
